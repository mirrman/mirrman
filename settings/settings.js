import { getSettings, setSettings, DEFAULT_SETTINGS } from '../utils/storage.js';
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  descSelect.value = settings.preferences?.descriptionStrategy || DEFAULT_SETTINGS.preferences.descriptionStrategy;
  privateCheckbox.checked = settings.preferences?.private || DEFAULT_SETTINGS.preferences.private;
  wikiCheckbox.checked = settings.preferences?.wiki ?? DEFAULT_SETTINGS.preferences.wiki;
  issuesCheckbox.checked = settings.preferences?.issues ?? DEFAULT_SETTINGS.preferences.issues;
  pullReqCheckbox.checked = settings.preferences?.pull_requests ?? DEFAULT_SETTINGS.preferences.pull_requests;
  releasesCheckbox.checked = settings.preferences?.releases ?? DEFAULT_SETTINGS.preferences.releases;
  milestonesCheckbox.checked = settings.preferences?.milestones ?? DEFAULT_SETTINGS.preferences.milestones;
  labelsCheckbox.checked = settings.preferences?.labels ?? DEFAULT_SETTINGS.preferences.labels;
  lfsCheckbox.checked = settings.preferences?.lfs || DEFAULT_SETTINGS.preferences.lfs;
  ...
  if (toggleBtn) {
    ...
    toggleBtn.title = giteaTokenInput.type === 'password' ? '显示 Token' : '隐藏 Token';
